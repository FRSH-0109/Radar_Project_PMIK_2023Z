...
\label{struct_d_m_a___init_type_def_ab94410c1333b512e271b1c135fe50916} 
...
Specifies if the data will be transferred from memory to peripheral, from memory to memory or from peripheral to memory. This parameter can be a value of \doxyref{DMA Data transfer direction}{p.}{group___d_m_a___data__transfer__direction} \label{struct_d_m_a___init_type_def_afe3adac32f5411b1a744c030f398aa5e} 
...
Specifies the Memory data width. This parameter can be a value of \doxyref{DMA Memory data size}{p.}{group___d_m_a___memory__data__size} \label{struct_d_m_a___init_type_def_a831756fbcd64feb1e570a9bf743b5b8d} 
...
Specifies whether the memory address register should be incremented or not. This parameter can be a value of \doxyref{DMA Memory incremented mode}{p.}{group___d_m_a___memory__incremented__mode} \label{struct_d_m_a___init_type_def_a0ffc93ec511ed9cf1663f6939bd3e839} 
...
\end{DoxyNote}
\label{struct_d_m_a___init_type_def_aca5b89241171c093fd0fc6dacf72683c} 
...
Specifies the Peripheral data width. This parameter can be a value of \doxyref{DMA Peripheral data size}{p.}{group___d_m_a___peripheral__data__size} \label{struct_d_m_a___init_type_def_a4925ca3ceb52340daddc92817dc304d9} 
...
Specifies whether the Peripheral address register should be incremented or not. This parameter can be a value of \doxyref{DMA Peripheral incremented mode}{p.}{group___d_m_a___peripheral__incremented__mode} \label{struct_d_m_a___init_type_def_a72acf77c0b19359eb70764505ae4bd70} 
...
Specifies the software priority for the DMAy Channelx. This parameter can be a value of \doxyref{DMA Priority level}{p.}{group___d_m_a___priority__level} \label{struct_d_m_a___init_type_def_a59f46df02cf1237d6888518fe2100209} 
...
\item 
Drivers/\+STM32\+G0xx\+\_\+\+HAL\+\_\+\+Driver/\+Inc/\textbf{ stm32g0xx\+\_\+hal\+\_\+dma.\+h}\end{DoxyCompactItemize}
