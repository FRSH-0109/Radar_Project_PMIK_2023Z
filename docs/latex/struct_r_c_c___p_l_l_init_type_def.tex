...
\label{struct_r_c_c___p_l_l_init_type_def_adb1ffaed93a1680042e24b5442b90af4} 
...
PLLM\+: Division factor for PLL VCO input clock. This parameter must be a value of \doxyref{PLLM Clock Divider}{p.}{group___r_c_c___p_l_l_m___clock___divider} ~\newline
 \label{struct_r_c_c___p_l_l_init_type_def_a2e8a73f7961f8d6570193c68daba88a6} 
...
PLLN\+: Multiplication factor for PLL VCO output clock. This parameter must be a number between Min\+\_\+\+Data = 8 and Max\+\_\+\+Data = 86 ~\newline
 \label{struct_r_c_c___p_l_l_init_type_def_ae2047a6040de6fcd43e0033a7b09a226} 
...
PLLP\+: PLL Division factor. User have to set the PLLQ parameter correctly to not exceed max frequency 64MHZ. This parameter must be a value of \doxyref{PLLP Clock Divider}{p.}{group___r_c_c___p_l_l_p___clock___divider} ~\newline
 \label{struct_r_c_c___p_l_l_init_type_def_a5777f8788531e0fc3f35b0e5d1c7a445} 
...
PLLR\+: PLL Division for the main system clock. User have to set the PLLR parameter correctly to not exceed max frequency 64MHZ. This parameter must be a value of \doxyref{PLLR Clock Divider}{p.}{group___r_c_c___p_l_l_r___clock___divider} ~\newline
